...
GLAPI void GLAPIENTRY glPolygonOffsetClamp(GLfloat factor, GLfloat units, GLfloat clamp);
...
GLAPI void GLAPIENTRY glBufferStorage(GLenum target, GLsizeiptr size, const void* data, GLbitfield flags);
...
GLAPI void GLAPIENTRY glMultiDrawElementsBaseVertex(GLenum mode, const GLsizei* count, GLenum type, const void* const* indices, GLsizei drawcount, const GLint* basevertex);
...
GLAPI void GLAPIENTRY glMultiDrawArraysIndirect(GLenum mode, const void* indirect, GLsizei drawcount, GLsizei stride);
GLAPI void GLAPIENTRY glMultiDrawElementsIndirect(GLenum mode, GLenum type, const void* indirect, GLsizei drawcount, GLsizei stride);
