# DirectMetal integration Actions

This development line has two durable Actions entry points:

- `build.yml` — the normal build and regression gate for pushes to, and pull requests targeting, `integration/directmetal-unified-20260815`. It owns macOS DirectMetal CTest/boundary verification, iPhoneOS arm64 packaging, and the Linux Vulkan reference regression.
